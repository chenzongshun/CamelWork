 ...
 * generated in the com.uindata.czs.cxf.wsdl.clinet package.
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://DefaultNamespace", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://DefaultNamespace", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.uindata.czs.cxf.wsdl.clinet
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://DefaultNamespace", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://DefaultNamespace", name = "operationResponse")
